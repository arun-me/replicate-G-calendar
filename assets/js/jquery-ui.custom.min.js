(function (e, t) {
    function i(t, i) {
        ...
        return "area" === o
            ? ((a = t.parentNode), (n = a.name), t.href && n && "map" === a.nodeName.toLowerCase() ? ((r = e("img[usemap=#" + n + "]")[0]), !!r && s(r)) : !1)
    ...
    (e.cleanData = function (t) {
        ...
        (e.widget = function (i, s, n) {
            ...
            (i = i.split(".")[1]),
                ...
                (o.prototype = e.widget.extend(h, { widgetEventPrefix: r ? h.widgetEventPrefix : i }, l, { constructor: o, namespace: u, widgetName: i, widgetFullName: a })),
                r
...
(function (e) {
    e.widget("ui.draggable", e.ui.mouse, {
        ...
        _getParentOffset: function () {
            ...
            return (
                "absolute" === this.cssPosition && this.scrollParent[0] !== document && e.contains(this.scrollParent[0], this.offsetParent[0]) && ((t.left += this.scrollParent.scrollLeft()), (t.top += this.scrollParent.scrollTop())),
                    ...
                    (r = p.snapElements[c].left),
                        ...
                        r - m > v || g > h + m || l - m > y || b > u + m || !e.contains(p.snapElements[c].item.ownerDocument, p.snapElements[c].item)
                            ...
                            : ("inner" !== f.snapMode &&
                                  ...
                                  (a = m >= Math.abs(r - v)),
                                  (o = m >= Math.abs(h - g)),
                                  s && (i.position.top = p._convertPositionTo("relative", { top: l - p.helperProportions.height, left: 0 }).top - p.margins.top),
                              ...
                              "outer" !== f.snapMode &&
                                  ...
                                  n && (i.position.top = p._convertPositionTo("relative", { top: u - p.helperProportions.height, left: 0 }).top - p.margins.top),
                                  a && (i.position.left = p._convertPositionTo("relative", { top: 0, left: r }).left - p.margins.left),
                                  o && (i.position.left = p._convertPositionTo("relative", { top: 0, left: h - p.helperProportions.width }).left - p.margins.left)),
                              !p.snapElements[c].snapping && (s || n || a || o || d) && p.options.snap.snap && p.options.snap.snap.call(p.element, t, e.extend(p._uiHash(), { snapItem: p.snapElements[c].item })),
            ...
            resize: function (t) {
                ...
                d[0] !== document && /static/.test(d.css("position")) && (c = h),
                    l.left < (o._helper ? h.left : 0) &&
                        ((o.size.width = o.size.width + (o._helper ? o.position.left - h.left : o.position.left - c.left)), u && (o.size.height = o.size.width / o.aspectRatio), (o.position.left = r.helper ? h.left : 0)),
